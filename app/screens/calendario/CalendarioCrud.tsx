        ...
        snapshot.docs.forEach((doc) => {
          ...
          try {
            if (data.date && typeof data.date.toDate === "function") {
              ...
              console.warn(
                "❌ Fecha inválida, usando fecha actual:",
                data.date
              );
              eventDate = new Date();
            }
      ...
      days.push(
        <View
          ...
          style={[
            styles.calendarDay,
            {
              width: dimensions.calendarCellSize,
              height: dimensions.calendarCellSize,
            },
          ]}
        />
      );
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      days.push(
        <TouchableOpacity
          ...
          onPress={() => handleDayPress(day)} // 👈 AÑADE ESTA LÍNEA
            ...
            <View style={styles.eventIndicator}>
              <View
                style={[
                  styles.eventDot,
                  {
                    backgroundColor: getEventTypeInfo(dayEvents[0].type).color,
                  },
                ]}
              />
              {dayEvents.length > 1 && (
  ...
  return (
    <SafeAreaView style={[styles.container, { padding: dimensions.padding }]}>
      ...
      >
        {/* Calendar Navigation */}
        <View
          style={[styles.calendarHeader, { marginBottom: dimensions.spacing }]}
        >
          <TouchableOpacity
        ...
        >
          ...
          <View style={styles.weekHeader}>
            {["D", "L", "M", "M", "J", "V", "S"].map((day, index) => (
              <View
                key={index}
                style={[styles.weekDay, { width: dimensions.calendarCellSize }]}
              >
                <Text
                  style={[
                    styles.weekDayText,
        ...
        <View style={styles.eventsSection}>
          <Text
            style={[
              styles.sectionTitle,
              { fontSize: dimensions.subtituloFontSize + 4 },
            ]}
          >
            Próximos Eventos
          </Text>
                  ...
                  <View style={styles.eventCardContent}>
                    ...
                    <View style={styles.eventInfo}>
                      <Text
                        style={[
                          styles.eventTitle,
                          { fontSize: dimensions.subtituloFontSize + 1 },
                        ]}
                      >
                        {event.titulo}
                      </Text>
          ...
          >
                  ...
                  {eventTypes.map((type) => (
                    <TouchableOpacity
                      ...
                      style={[
                        ...
                        {
                          backgroundColor:
                            eventType === type.key ? type.color : "#f1f5f9",
                        },
                      ]}
                ...
                {selectedDate && (
                  <View style={styles.selectedDateContainer}>
                    ...
                    >
                      ...
                      {monthNames[selectedDate.getMonth()]} de{" "}
            ...
            <View style={styles.modalActions}>
              ...
              <TouchableOpacity
                style={[
                  styles.saveButton,
                  !eventTitle.trim() && styles.disabledButton,
                ]}
                onPress={saveEvent}
