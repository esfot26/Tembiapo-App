...
const EditarPerfil = ({ route, navigation }: EditProfileScreenProps) => {
    ...
    const validateField = (field: string, value: string) => {
        ...
        switch (field) {
            ...
            case "username":
                ...
                break
            case "telefono":
                newErrors[field] = value.length > 0 && !/^\d{8,15}$/.test(value.replace(/\s/g, ""))
                break
            case "fechaNacimiento":
                newErrors[field] = value.length > 0 && !/^\d{2}\/\d{2}\/\d{4}$/.test(value)
                break
        }
            ...
            <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.keyboardView}>
                ...
                >
                    ...
                    <View style={styles.formContainer}>
                        ...
                        {renderInput("fechaNacimiento", "Fecha de nacimiento (DD/MM/AAAA)", "calendar-outline")}
                    </View>
                    ...
                    >
                        {loading ? (
                            <ActivityIndicator color="white" size={width * 0.01} />
                        ) : (
                            <>
